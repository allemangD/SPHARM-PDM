...
# label_path = Path(
#     "data/8844-0014-01_tricuspid_septal_leaflet.nii.gz"
# )
...
for label_path in samples.glob('*.nii.gz'):
    name = label_path.name.removesuffix('.nii.gz')
    out_path = label_path.with_name(name).with_suffix('.vtk')
    print(label_path, '->', out_path)
