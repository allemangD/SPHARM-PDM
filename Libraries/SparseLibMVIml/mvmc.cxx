...
MV_ColMat_COMPLEX::MV_ColMat_COMPLEX(int m, int n) : v_(m * n), dim0_(m), dim1_(n), lda_(m), ref_(0) {}

MV_ColMat_COMPLEX::MV_ColMat_COMPLEX(int m, int n, const COMPLEX& s)
...
const MV_ColMat_COMPLEX MV_ColMat_COMPLEX::operator()(const MV_VecIndex& I, const MV_VecIndex& J) const {
