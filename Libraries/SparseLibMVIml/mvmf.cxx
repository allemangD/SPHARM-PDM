...
MV_ColMat_float::MV_ColMat_float(int m, int n) : v_(m * n), dim0_(m), dim1_(n), lda_(m), ref_(0) {}

MV_ColMat_float::MV_ColMat_float(int m, int n, const float& s)
...
MV_ColMat_float::MV_ColMat_float(float* d, int m, int n) : v_(m * n), dim0_(m), dim1_(n), lda_(m), ref_(0) {
  int mn = m * n;
...
const MV_ColMat_float MV_ColMat_float::operator()(const MV_VecIndex& I, const MV_VecIndex& J) const {
