...
MV_ColMat_double::MV_ColMat_double(int m, int n) : v_(m * n), dim0_(m), dim1_(n), lda_(m), ref_(0) {}

MV_ColMat_double::MV_ColMat_double(int m, int n, const double& s)
...
const MV_ColMat_double MV_ColMat_double::operator()(const MV_VecIndex& I, const MV_VecIndex& J) const {
