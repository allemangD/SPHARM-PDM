...
MV_Vector_int::MV_Vector_int(int n) : p_(new int[n]), dim_(n), ref_(0) {
  if (p_ == NULL) {
...
MV_Vector_int::MV_Vector_int(int n, const int& v) : p_(new int[n]), dim_(n), ref_(0) {
  if (p_ == NULL) {
    std::cerr << "Error: NULL pointer in MV_Vector_int(int) constructor "
              << "\n";
    std::cerr << "       Most likely out of memory... "
...
MV_Vector_int::MV_Vector_int(const MV_Vector_int& m) : p_(new int[m.dim_]), dim_(m.dim_), ref_(0) {
  if (p_ == NULL) {
...
MV_Vector_int::MV_Vector_int(int* d, int n) : p_(new int[n]), dim_(n), ref_(0) {
  if (p_ == NULL) {
...
MV_Vector_int::MV_Vector_int(const int* d, int n) : p_(new int[n]), dim_(n), ref_(0) {
  if (p_ == NULL) {
    std::cerr << "Error: Null pointer in MV_Vector_int(int*, int) "
              << "\n";
    exit(1);
...
MV_Vector_int MV_Vector_int::operator()(void) { return MV_Vector_int(p_, dim_, MV_Vector_::ref); }

const MV_Vector_int MV_Vector_int::operator()(void) const { return MV_Vector_int(p_, dim_, MV_Vector_::ref); }
...
MV_Vector_int MV_Vector_int::operator()(const MV_VecIndex& I) {
  ...
  if (I.all()) {
    ...
    return MV_Vector_int(p_ + I.start(), I.end() - I.start() + 1, MV_Vector_::ref);
  }
}
