...
class MV_Vector_float {
 ...
 public:
  ...
  //
  MV_Vector_float(float *d, int N, MV_Vector_::ref_type i) : p_(d), dim_(N), ref_(i) {}

  MV_Vector_float(const MV_Vector_float &V, MV_Vector_::ref_type i) : p_(V.p_), dim_(V.dim_), ref_(i) {}
