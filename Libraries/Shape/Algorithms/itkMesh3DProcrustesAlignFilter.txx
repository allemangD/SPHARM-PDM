...
Mesh3DProcrustesAlignFilter<TInputMesh, TOutputMesh>::Mesh3DProcrustesAlignFilter() {
...
template <class TInputMesh, class TOutputMesh>
typename itk::ProcessObject::DataObjectPointer Mesh3DProcrustesAlignFilter<TInputMesh, TOutputMesh>::
...
Mesh3DProcrustesAlignFilter<TInputMesh, TOutputMesh>::GetOutput(unsigned int idx) {
  return m_MeshTransform[idx]->GetOutput();
  // return static_cast<TOutputMesh*>(this->ProcessObject::GetOutput(idx));
}

template <class TInputMesh, class TOutputMesh>
void Mesh3DProcrustesAlignFilter<TInputMesh, TOutputMesh>::SetNumberOfInputs(unsigned int num) {
...
template <class TInputMesh, class TOutputMesh>
void Mesh3DProcrustesAlignFilter<TInputMesh, TOutputMesh>::SetInput(unsigned int idx, InputMeshPointer mesh) {
  this->ProcessObject::SetNthInput(idx, mesh);
  m_MeshTransform[idx]->SetInput(this->GetInput(idx));
}

template <class TInputMesh, class TOutputMesh>
void Mesh3DProcrustesAlignFilter<TInputMesh, TOutputMesh>::GenerateData() {
...
Mesh3DProcrustesAlignFilter<TInputMesh, TOutputMesh>::GetMeshCenter(unsigned int idx) {
...
Mesh3DProcrustesAlignFilter<TInputMesh, TOutputMesh>::GetProcrustesMatch(
...
template <class TInputMesh, class TOutputMesh>
void Mesh3DProcrustesAlignFilter<TInputMesh, TOutputMesh>::CalculateMean() {
