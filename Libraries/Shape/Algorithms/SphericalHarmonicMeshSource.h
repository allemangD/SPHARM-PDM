...
class SphericalHarmonicMeshSourceException : public itk::ExceptionObject {
 public:
  ...
  /** Constructor. */
  SphericalHarmonicMeshSourceException(
      const char *file,
      unsigned int line,
...
class SphericalHarmonicMeshSource : public itk::MeshSource<SphericalHarmonicMeshSourceMeshType> {
 public:
  ...
  MeshType *GetOutputParaMesh() { return outputParaMesh; }

  double *GetPrecomputedIcosList() { return m_icos; }
 ...
 protected:
  ...
  void set_up_icosahedron_triangs(
      Point3 *all_vert,
      Point3 *all_triangs,
      int subdiv,
      int n_vert,
