...
class TPoint3D {
 public:
  ...
  friend int operator!=(const TPoint3D& p1, const TPoint3D& p2) { return !(p1 == p2); }
  ...
  friend float pdist(const TPoint3D& p1, const TPoint3D& p2) {
    return sqrt(
        (double)(p1.x_ - p2.x_) * (p1.x_ - p2.x_) + (p1.y_ - p2.y_) * (p1.y_ - p2.y_) +
...
class TPointFloat3D {
 public:
  ...
  friend int operator!=(const TPointFloat3D& p1, const TPointFloat3D& p2) { return !(p1 == p2); }
