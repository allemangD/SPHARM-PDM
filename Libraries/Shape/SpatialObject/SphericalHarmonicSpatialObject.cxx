...
bool SphericalHarmonicSpatialObject::ValueAtInObjectSpace(
    const PointType& /* point */, double& /* value */, unsigned int /* depth */, const std::string& /* name */
) const {
  return false;
}

bool SphericalHarmonicSpatialObject::IsEvaluableAtInObjectSpace(
    const PointType& /* point */, unsigned int /* depth */, const std::string& /* name */
) const {
  return false;
}
