...
template <class TMesh, class TAttributeType>
typename AttributeMeshSpatialObject<TMesh, TAttributeType>::TAttributeListType
AttributeMeshSpatialObject<TMesh, TAttributeType>::GetAttribute(unsigned int vertIndex) {
