...
class SphericalHarmonicPolynomialException : public itk::ExceptionObject {
 public:
  ...
  /** Constructor. */
  SphericalHarmonicPolynomialException(
      const char *file,
      unsigned int line,
...
class SphericalHarmonicPolynomial {
 public:
  ...
  unsigned int GetDegree(void) const { return m_Degree; }

  void SetDegree(unsigned int d) { m_Degree = d; }
  ...
  void GetGradKappa(
      unsigned int from_l, unsigned int to_l, unsigned int family, double phi, double theta, double *gradKappa
  );

  void GetOneRidgePoint(
