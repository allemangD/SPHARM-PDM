...
SphericalHarmonicCoefficientFileWriter::SphericalHarmonicCoefficientFileWriter() { m_FileName = ""; }
...
void SphericalHarmonicCoefficientFileWriter::Update() {
  ...
  if (file == NULL) {
    throw SphericalHarmonicCoefficientFileWriterException(
        __FILE__, __LINE__, "Coef file couldn't be created"
    );
  }
